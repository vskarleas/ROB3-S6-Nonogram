...
Les instances avec * etait incomplet en utilisant la methode incplpet de l'algorithm. Pour leur completion, l'algorithme complet etait utilisé pour obtenir une solution complet.  En outre, il faut noter qu'on onbserve une diminuation du temps de traitment par 25% en comparant les deux differents fonctions T.
...
## Difficultés/Problemes reconnues
...
1. La completion de la fonction T(j,l) pour qu'elle soit capable de repondre correctment à tous les scenarios possibles. Grace aux tests individuels et precis, on etait capable de localiser les faux reponses aux differents itterations. Par exemple, voici comment on a procedé:
   ![1710882802914](image/READMEcopy/1710882802914.png)

   ![1710882827587](image/READMEcopy/1710882827587.png)
2. Detecter les cas particuliers ou le program de colorisation ne marcherait pas. Dans ce cas, le debaugeur etait notre meilleur amis pour analyses le comportement etape par etape.
